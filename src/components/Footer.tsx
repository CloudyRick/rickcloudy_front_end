import { FaTwitter, FaGithub, FaInstagram, FaLinkedinIn } from 'react-icons/fa6'
            ...
            <div className="container mx-auto px-4">
                        ...
                        <div className='mt-6 lg:mb-0 mb-6 ml-3'>
                            <ul className='flex flex-row space-x-7 text-2xl'>
                                <li className='shadow-md'>
                                    <a className='text-gray-700 transition hover:opacity-75' href=""><FaGithub /></a>
                                </li>
                                <li>
                                    <a className='text-gray-700 transition hover:opacity-75' href=""><FaTwitter/></a>
                                </li>
                                <li>
                                    <a className='text-gray-700 transition hover:opacity-75' href=""><FaInstagram/></a>
                                </li>
                                <li>
                                    <a className='text-gray-700 transition hover:opacity-75' href=""><FaLinkedinIn/></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className='w-full lg:w-1/2 px-4'>
                        <div className='flex flex-wrap items-top mb-6'>
                            <div className='w-full lg:w-1/3 px-4 ml-auto'>
                                <span className='block uppercase text-gray-800 text-sm font-semibold mb-2'>Usefull links</span>
                ...
                <div className="flex flex-wrap items-center md:justify-between justify-center">
                    <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                        ...
                        Copyright © <span id="get-current-year">2021</span><a href="" className="text-blueGray-500 hover:text-gray-800" target="_blank"> Created by </a>
